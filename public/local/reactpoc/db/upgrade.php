...
/**
 * Upgrade steps for local_reactpoc.
 *
 ...
 * @return bool
 */
function xmldb_local_reactpoc_upgrade(int $oldversion): bool {
    global $DB;
    $dbman = $DB->get_manager();

    if ($oldversion < 2026032500) {
        $table = new xmldb_table('local_reactpoc_items');
        ...
        upgrade_plugin_savepoint(true, 2026032500, 'local', 'reactpoc');
    }
