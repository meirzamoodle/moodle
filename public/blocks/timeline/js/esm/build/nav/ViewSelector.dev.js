...
const VIEW_OPTIONS = [
  { name: "sortbydates", labelKey: "sortbydates", fallback: "Sort by dates" },
  { name: "sortbycourses", labelKey: "sortbycourses", fallback: "Sort by courses" }
];
  ...
  return /* @__PURE__ */ jsxDEV("div", { "data-region": "view-selector", className: "dropdown mb-1", children: [
    /* @__PURE__ */ jsxDEV(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxDEV("span", { id: SPAN_ID, "data-active-item-text": "", children: /* @__PURE__ */ jsxDEV(String, { identifier: activeOption.labelKey, component: "block_timeline", children: activeOption.fallback }, void 0, false, {
      ...
      "div",
      {
        ...
        children: VIEW_OPTIONS.map((option) => /* @__PURE__ */ jsxDEV(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxDEV(String, { identifier: option.labelKey, component: "block_timeline", children: option.fallback }, void 0, false, {
              fileName: "public/blocks/timeline/js/esm/src/nav/ViewSelector.tsx",
              lineNumber: 118,
              columnNumber: 25
            }, this)
