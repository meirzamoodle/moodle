        ...
        >
            <div className="d-flex flex-wrap pb-1">
                <div className="d-flex me-auto pb-1 mw-100 timeline-name">
                    ...
                    {event.icon && (
                        <div className={
                            `small courseicon align-self-start align-self-center` +
                            ` mx-2 mb-1 mb-sm-0 text-nowrap activityiconcontainer${purposeClass}`
                        }>
                            <ActivityIcon iconurl={event.icon.iconurl} alt={event.icon.alttext} />
                        </div>
                    )}
                    ...
                    <div className="event-name-container flex-grow-1 line-height-3 nowrap text-truncate">
                        <div className="d-flex">
                            <h5 className="h6 event-name mb-0 pb-1 text-truncate">
                                {event.overdue && (
                                    <span className="badge rounded-pill bg-danger text-white ms-1 float-end">
                                        <String identifier="overdue" component="block_timeline">Overdue</String>
                                    </span>
                                )}
                        ...
                        <h5 className="h6 event-action">
                            ...
                            >
                                ...
                                {event.action.showitemcount && (
                                    <span className="badge bg-secondary text-dark">{event.action.itemcount}</span>
                                )}
                            </a>
                        </h5>
                    </div>
