        ...
        <div data-region="view-selector" className="dropdown mb-1">
            ...
            >
                <span id={SPAN_ID} data-active-item-text="">
                    <String identifier={activeOption.labelKey} component="block_timeline">{activeOption.fallback}</String>
                </span>
            </button>
            ...
            >
                {VIEW_OPTIONS.map(option => (
                    ...
                    >
                        <String identifier={option.labelKey} component="block_timeline">{option.fallback}</String>
                    </a>
                ))}
            </div>
        </div>
