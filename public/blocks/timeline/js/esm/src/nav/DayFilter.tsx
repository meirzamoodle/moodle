...
const TOP_OPTIONS: FilterOption[] = [
    {name: 'all', labelKey: 'all', labelComponent: 'core', fallback: 'All', dataFrom: '-14'},
    {name: 'overdue', labelKey: 'overdue', labelComponent: 'block_timeline', fallback: 'Overdue', dataFrom: '-14', dataTo: '1'},
];

/** Grouped date-range items (below the divider). */
const GROUP_OPTIONS: FilterOption[] = [
    {
        name: 'next7days', labelKey: 'next7days', labelComponent: 'block_timeline',
        fallback: 'Next 7 days', dataFrom: '0', dataTo: '7',
    },
    {
        name: 'next30days', labelKey: 'next30days', labelComponent: 'block_timeline',
        fallback: 'Next 30 days', dataFrom: '0', dataTo: '30',
    },
    {
        name: 'next3months', labelKey: 'next3months', labelComponent: 'block_timeline',
        fallback: 'Next 3 months', dataFrom: '0', dataTo: '90',
    },
    {
        name: 'next6months', labelKey: 'next6months', labelComponent: 'block_timeline',
        fallback: 'Next 6 months', dataFrom: '0', dataTo: '180',
    },
];
...
export default function DayFilter({activeFilter, onChange}: DayFilterProps) {
    ...
    const renderItem = (option: FilterOption) => (
        ...
        >
            <String identifier={option.labelKey} component={option.labelComponent}>{option.fallback}</String>
        </a>
    );
            ...
            <div id={MENU_ID} role="menu" className="dropdown-menu" data-show-active-item="" data-skip-active-class="true">
                ...
                <div role="group" aria-labelledby={GROUP_ID}>
                    <div className="h6 dropdown-header" role="presentation" id={GROUP_ID}>
                        <String identifier="duedate" component="block_timeline">Due date</String>
                    </div>
