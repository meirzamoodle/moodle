    ...
    if (displayedCourses.length === 0) {
            ...
            return (
                <div className="text-xs-center text-center mt-3" data-region="no-events-empty-message">
                    ...
                    <p className="text-muted mt-1">
                        <String identifier="noevents" component="block_timeline">No activities require action</String>
                    </p>
                </div>
            );
        }
        return (
            <div className="text-xs-center text-center mt-3" data-region="no-courses-empty-message">
                ...
                <p className="text-muted mt-1">
                    <String identifier="nocoursesinprogress" component="block_timeline">No in-progress courses</String>
                </p>
            </div>
        );
    }
                                    ...
                                    {state.events.length === 0 ? (
                                        <div className="text-xs-center text-center mt-3" data-region="no-events-empty-message">
                                            <p className="text-muted mt-1">
                                                ...
                                                >No activities require action</String>
                                            </p>
                                        </div>
                                    ) : (
            ...
            {hasMoreCourses && (
                <div className="text-xs-center text-center pt-3" data-region="more-courses-button-container">
                    ...
                    >
                        ...
                        <String identifier="morecourses" component="block_timeline">Show more courses</String>
                    </button>
                </div>
            )}
        </>
