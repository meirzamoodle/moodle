...
define([
    ...
    var deselectItem = function(options, state, item, originalSelect) {
        ...
        .then(function() {
            ...
            return announceChanges(state.selectionId, selectedItemText, 'deselect');
        });
    };
    ...
    var createItem = function(options, state, originalSelect) {
        ...
        .then(function() {
            // Anounce the changes to the assistive technology.
            return announceChanges(state.selectionId, query.trim(), 'added');
        })
        .then(function() {
    ...
    var selectCurrentItem = function(options, state, originalSelect, selectedItem) {
        ...
        .then(function() {
            // Anounce the changes to the assistive technology.
            return announceChanges(state.selectionId, selectedItem, 'added');
        })
        .then(function() {
     ...
     */
    const announceChanges = (selectionId, tagname, action) => {
        if (!tagname) {
            return $.Deferred().resolve();
        }
        ...
        return str.get_string(action, 'core', tagname)
            .done((result) => {
