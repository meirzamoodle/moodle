...
export default class IconSystemStandard extends IconSystem {
     ...
     * @param {Object} [options={}] - Additional options for rendering the icon.
     * @return {string}
     */
    renderIcon(key, component, title, template, options = {}) {
        ...
        if (options.hasOwnProperty('aria-hidden')) {
            templatecontext['aria-hidden'] = options['aria-hidden'];
        }
