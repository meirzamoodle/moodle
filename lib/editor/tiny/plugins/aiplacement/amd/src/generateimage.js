...
export default class GenerateImage extends GenerateBase {
    ...
    async handleSubmit(root, submitBtn) {
        ...
        try {
            ...
            if (this.responseObj.errorname) {
                this.handleGenerationError(root, submitBtn, this.responseObj.errorname, this.responseObj.errormessage);
            } else {
     ...
     */
    async handleGenerationError(root, submitBtn, errorName = '', errorMessage = '') {
        if (!errorName) {
