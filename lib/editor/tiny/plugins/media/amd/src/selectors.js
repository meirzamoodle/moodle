...
export default {
    IMAGE: {
        ...
        elements: {
            ...
            dropzone: '.tiny_image_dropzone',
            dropzoneIcon: '.tiny_image_dropzone_icon',
            dropzoneLabel: '.tiny_image_dropzone_label',
            dropzoneIconLabel: '.tiny_image_dropzone_iconlabel',
