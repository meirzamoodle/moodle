...
export class ImageDetails {
    ...
    handleKeyupCharacterCount() {
        const altValueLength = this.root.querySelector(Selectors.IMAGE.elements.alt).value.length;
        const altCountElement = this.root.querySelector(Selectors.IMAGE.elements.altCount);
        const altCurrentCountElement = this.root.querySelector(Selectors.IMAGE.elements.altCurrentCount);

        // Toggle 'text-danger' class based on character count.
        altCountElement.classList.toggle('text-danger', altValueLength >= MAX_LENGTH_ALT);

        // Update the current character count.
        altCurrentCountElement.innerHTML = altValueLength;
    }
    /**
