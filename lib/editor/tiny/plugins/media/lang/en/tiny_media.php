...
$string['draganddrop'] = 'Drag and drop an image to upload<br>or <a href="javascript:void(0)" class="bold">click to select</a>.';
$string['droptoupload'] = 'Drop an image to upload';
