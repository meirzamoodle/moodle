...
class Google_Service_QPXExpress_Data extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_AircraftData[] */
  protected $aircraft;

  /** @var Google_Service_QPXExpress_AirportData[] */
  protected $airport;

  /** @var Google_Service_QPXExpress_CarrierData[] */
  protected $carrier;

  /** @var Google_Service_QPXExpress_CityData[] */
  protected $city;

  /** @var Google_Service_QPXExpress_TaxData[] */
  protected $tax;
...
class Google_Service_QPXExpress_FreeBaggageAllowance extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_BagDescriptor[] */
  protected $bagDescriptor;
...
class Google_Service_QPXExpress_PricingInfo extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_FareInfo[] */
  protected $fare;

  /** @var Google_Service_QPXExpress_PassengerCounts */
  protected $passengers;

  /** @var Google_Service_QPXExpress_SegmentPricing[] */
  protected $segmentPricing;

  /** @var Google_Service_QPXExpress_TaxInfo[] */
  protected $tax;
...
class Google_Service_QPXExpress_SegmentInfo extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_FlightInfo */
  protected $flight;

  /** @var Google_Service_QPXExpress_LegInfo[] */
  protected $leg;
...
class Google_Service_QPXExpress_SegmentPricing extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_FreeBaggageAllowance[] */
  protected $freeBaggageOption;
...
class Google_Service_QPXExpress_SliceInfo extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_SegmentInfo[] */
  protected $segment;
...
class Google_Service_QPXExpress_SliceInput extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_TimeOfDayRange */
  protected $permittedDepartureTime;
...
class Google_Service_QPXExpress_TripOption extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_PricingInfo[] */
  protected $pricing;

  /** @var Google_Service_QPXExpress_SliceInfo[] */
  protected $slice;
...
class Google_Service_QPXExpress_TripOptionsRequest extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_SliceInput[] */
  protected $slice;
...
class Google_Service_QPXExpress_TripOptionsResponse extends Google_Collection
{
  ...
  /** @var Google_Service_QPXExpress_Data */
  protected $data;

  /** @var Google_Service_QPXExpress_TripOption[] */
...
class Google_Service_QPXExpress_TripsSearchRequest extends Google_Model
{
  ...
  /** @var Google_Service_QPXExpress_TripOptionsRequest */
  protected $request;
...
class Google_Service_QPXExpress_TripsSearchResponse extends Google_Model
{
  ...
  /** @var Google_Service_QPXExpress_TripOptionsResponse */
  protected $trips;
