 ...
 *
 * @covers \core\output\requirements\page_requirements_manager
 */
final class outputrequirementslib_test extends \advanced_testcase {
     ...
     *
     * @param url $moodleurl The <u>moodle_url</u> instance pointing to a web resource.
     ...
     */
    public function test_js_fix_url_moodle_url(url $moodleurl, string $expected): void {
