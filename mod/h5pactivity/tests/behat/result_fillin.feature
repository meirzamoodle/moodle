...
Feature: View fill the blanks attempt report
  ...
  Scenario: View attempt in a fill the blanks content
    ...
    And "//span[@title='Your answer is incorrect']" "xpath_element" should exist in the "Brasilia" "table_row"
    And I should see "Emerald city" in the "Washington" "table_row"
    And I should see "Narnia" in the "Berlin" "table_row"
    And "//span[@title='Your answer is incorrect']" "xpath_element" should exist in the "Berlin" "table_row"
    And "//span[@title='Your answer is correct']" "xpath_element" should exist in the "Canberra" "table_row"
