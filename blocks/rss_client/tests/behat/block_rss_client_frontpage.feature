...
Feature: Enable RSS client block menu on the frontpage
  ...
  Scenario: Configuring the RSS block on the frontpage
    ...
    And I should see "There are no RSS feeds defined for this site."

    # Test filling in an empty URL in the input.
    And I click on "Add a new feed" "radio"
    ...
    Then I should see "NASA" in the "Choose the feeds which you would like to make available in this block:" "select"
