...
$string['fileredact:exifremover:enabled_desc'] = 'By default, EXIF Remover only supports JPG files using PHP GD. This degrades the quality of the image and removes the orientation tag.

To enhance the performance of EXIF Remover, please configure the ExifTool settings below. More information about installing ExifTool can be found at <a href="https://exiftool.sourceforge.net/install.html">https://exiftool.sourceforge.net/install.html</a>.';
