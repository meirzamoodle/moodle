...
$string['tokennamehint'] = 'If the name is empty then a default name will be used.';
$string['tokennameprefix'] = 'Webservice-{$a}';
$string['tokennewmessage'] = 'Make sure you copy the token now. You won\'t be able to see it again once you leave this page!';
