...
$string['providerinstancedeletefailed'] = 'Cannot delete the {$a->provider} AI Provider instance. The provider is either in use or there\'s a database issue. Check if the private is active or contact your database administrator for help.';
