...
$string['privacy:metadata:ai_action_generate_image:id'] = 'The action id.';
...
$string['privacy:metadata:ai_action_generate_text:id'] = 'The action id.';
...
$string['privacy:metadata:ai_action_summarise_text:id'] = 'The action id.';
