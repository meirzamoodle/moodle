        ...
        return [
            ...
            'Import settings and plugins from a valid XML file' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'import_settings_plugins.xml')
                ),
                'expectedpreset' => true,
            ...
            'Import only settings from a valid XML file' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'import_settings.xml')
                ),
                'expectedpreset' => true,
                'expectedsettings' => true,
            ...
            'Import settings and plugins from a valid XML file with Starter name, which will be marked as non-core' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'import_starter_name.xml')
                ),
                'expectedpreset' => true,
                'expectedsettings' => true,
                'expectedplugins' => true,
            ...
            'Import settings from an invalid XML file' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'invalid_xml_file.xml')
                ),
                'expectedpreset' => false,
            ...
            'Import unexisting settings category' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'unexisting_category.xml')
                ),
                'expectedpreset' => false,
                'expectedsettings' => false,
                'expectedplugins' => false,
            ...
            'Import unexisting setting' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'unexisting_setting.xml')
                ),
                'expectedpreset' => false,
                'expectedsettings' => false,
                'expectedplugins' => false,
            ...
            'Import valid settings with one unexisting setting too' => [
                'filecontents' => file_get_contents(
                    filename: self::get_fixture_path('core_adminpresets', 'import_settings_with_unexisting_setting.xml'),
                ),
                'expectedpreset' => true,
                'expectedsettings' => false,
                'expectedplugins' => false,
