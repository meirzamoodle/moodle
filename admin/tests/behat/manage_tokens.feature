...
Feature: Manage external services tokens
  ...
  Scenario: Add a token to user identified by name and then delete that token
    ...
    # Verify the message and the "Copy Token" button.
    And I should see "Make sure you copy the token now. You won't be able to see it again once you leave this page!"
    And "Copy Token" "button" should exist

    # New token can only read once.
    And I reload the page
    And I should not see "Make sure you copy the token now. You won't be able to see it again once you leave this page!"
    And "Copy Token" "button" should not exist
